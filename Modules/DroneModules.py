...
try:
    import gtk.gdk
    # Module de capture des photos
except ImportError:
    sys.exit("""You need gtk!
                run sudo apt-get install python-gtk2-doc
                """)
try:
    import chilkat
    ...
    if os.path.exists("2.6"):
        ...
        print(
        "---- To install the Chilkat module, copy chilkat.py and _chilkat.so to the Python 2.6 site packages directory.")
